"""
Python programma teksta apstrādei ar Hugging Face modeļiem.
Programma veic trīs galvenās funkcijas:
1. Apkopo tekstu no .txt faila
2. Izvelk atslēgvārdus
3. Ģenerē testa jautājumus ar atbildēm
"""
...
class TextProcessor:
    ...
    def __init__(self, hf_token: str = None):
        ...
        self.text_generation_model = "mistralai/Mistral-7B-Instruct-v0.2"
    ...
    def extract_keywords(self, text: str, num_keywords: int) -> List[str]:
        ...
        try:
            ...
            prompt = f"""Extract exactly {num_keywords} key descriptive keywords from the following text. 
...
Keywords:"""
            ...
            # Noņemam iespējamos papildus tekstus
            if '\n' in keywords_text:
                keywords_text = keywords_text.split('\n')[0]
            
            keywords = [k.strip() for k in keywords_text.split(',')]
            # Ierobežojam līdz prasītajam skaitam
            keywords = keywords[:num_keywords]
            
            return keywords
            
        except Exception as e:
            print(f"Kļūda izvelkot atslēgvārdus: {e}")
...
Quiz:"""
            ...
            print(f"Kļūda ģenerējot jautājumus: {e}")
            return [{"error": str(e)}]
...
def main():
    ...
    # Ja ir Hugging Face tokens, var pievienot šeit: TextProcessor(hf_token="your_token")
